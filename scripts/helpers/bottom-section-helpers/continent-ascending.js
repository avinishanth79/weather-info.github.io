export function continentAscendingFunc(continentAscendingArray,temperatureClick,A,B){

    function continentAscendFunc(a,b){
    ...
    continentAscendingArray.sort(continentAscendFunc);
}
